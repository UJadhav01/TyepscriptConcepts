...
function gradeCalculator() {
  ...
  let mathMarks:any= prompt("Please enter maths marks");
  let physicsMarks:any= prompt("Please enter physics marks");
  let chemistryMarks:any= prompt("Please enter chemistry marks");
  ...
  let averageMarks=((+mathMarks)+(+physicsMarks)+(+chemistryMarks))/(+3);

  if (averageMarks < 0 || averageMarks < 35) {
   return document.write(`<br/><br/>Your average marks are ${averageMarks} , you are fail`);
  } else if (averageMarks >= 35 && averageMarks < 70) {
    return document.write(`<br/><br/>Your average marks are ${averageMarks} , you get grade C`);
  } else if (averageMarks >= 70 && averageMarks < 90) {
    return document.write(`<br/><br/>Your average marks are ${averageMarks} , you get grade B`);
  } else if (averageMarks >= 90 && averageMarks <= 100) {
   return  document.write(`<br/><br/>Your average marks are ${averageMarks} , you get grade A`);
  }
}
gradeCalculator();
